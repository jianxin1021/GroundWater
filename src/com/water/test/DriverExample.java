...
public class DriverExample {
    private static final String URL_DEFAULT = "jdbc:firebirdsql://localhost:3050/G:\\杨洸\\软件工程\\20周课程设计选2017.07.01\\20周课程设计选2017.07.01\\题目3 地下水监测系统\\附件-系统数据库\\LENNY.FDB";
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            try {
                ...
                java.sql.ResultSet tables = dbMetaData.getTables(null, null, "%", new String[] { "B_USER" });
                while (tables.next()) {
			...
			*/
            ...
            try {
            	stmt = con.createStatement();
                rs = stmt.executeQuery("select * from N_GROUNDHISDATA");
                while(rs.next()){
                	System.out.println("时间:" + rs.getString("DATETIME"));
                }
            } catch (java.sql.SQLException e) {
